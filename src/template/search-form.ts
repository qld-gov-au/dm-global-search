...
export function searchForm () {
  ...
  return html`
        <form action="#" role="search" class="qg-site-search__form qg-site-search__component qg-search-form qg-site-search__multiple-forms" data-suggestions="${search_url}/s/suggest.json?collection=${search_collection}&fmt=json%2B%2B&alpha=0.5&profile=disaster" data-results-url="${API_URL}?collection=${search_collection}&profile=disaster&smeta_sfinder_sand=yes">
